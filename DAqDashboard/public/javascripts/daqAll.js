...
function processData() {
	d3.select("h1").text("DAq Dashboard - ALL - " + track.name);
	...
	// 	tooltip: true
	// }
	// var gpsChart = new GPSChart(track, gpsParams, data, geo);	
	// var gForceChart = new GForceChart(gpsParams, data);
	...
	var engineLoadGraph = new SingleLineChart(params, data, DataPoints.ENGINELOAD);
	var coolantTempGraph = new SingleLineChart(params, data, DataPoints.COOLANTTEMP);
	var rpmGraph = new SingleLineChart(params, data, DataPoints.RPM);
	var obdSpeedGraph = new SingleLineChart(params, data, DataPoints.OBDSPEED);
	var gpsSpeedGraph = new SingleLineChart(params, data, DataPoints.GPSSPEED);
	var intakeTempGraph = new SingleLineChart(params, data, DataPoints.INTAKETEMP);
	var mafGraph = new SingleLineChart(params, data, DataPoints.MAF);
	var throttlePosGraph = new SingleLineChart(params, data, DataPoints.THROTTLEPOS);
	var timingAdvanceGraph = new SingleLineChart(params, data, DataPoints.TIMINGADV); 
}
